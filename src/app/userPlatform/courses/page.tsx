...
export default function User_courses() {
    return (
        <div className=" h-svh w-full flex flex-col" >
            ...
            <div className="w-full flex gap-10 text-white pt-10 bg-secondary/60">
            ...
            <div className="h-full flex flex-col space-y-8 px-10 pt-10 ">
                <div><h1>CCNA</h1><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam recusandae voluptatem error repellendus ut aspernatur. Voluptatibus, modi? Doloribus, maiores minima facilis quidem distinctio ullam soluta, quasi illum, placeat vero eaque!</p></div>
                <div>user courses:</div>
                <div className="grid grid-flow-row grid-cols-3 gap-4">
                <div className="p-5 h-56 bg-[#21233B]/60"></div>
                <div className="p-5 h-56 bg-[#21233B]/60"></div>
                <div className="p-5 h-56 bg-[#21233B]/60"></div>
                <div className="p-5 h-56 bg-[#21233B]/60"></div>
                <div className="p-5 h-56 bg-[#21233B]/60"></div>
